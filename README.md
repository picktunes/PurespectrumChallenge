The application uses Spring framework and was developed using Intellij IDEA and Gradle. In case to execute it through a development enviroment is recommendable use the same.
