The application uses Spring framework and was developed using Intellij IDEA and Gradle. In case to execute it trough a development enviroment is recommendable use the same.
